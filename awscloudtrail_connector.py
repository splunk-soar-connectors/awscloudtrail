...
class AwsCloudtrailConnector(BaseConnector):
    ...
    def _make_boto_call(self, action_result, method, **kwargs):
        ...
        if can_paginate:
            ...
            res_dict = {"response_list": self._sanitize_data(updated_list), "next_token": next_token}
    ...
    def _handle_run_query(self, param):
        ...
        try:
            ...
            return RetVal(
                action_result.set_status(phantom.APP_ERROR, "Invalid date format. Remember to left-pad in the format of YYYY-MM-DD"), None
            )
